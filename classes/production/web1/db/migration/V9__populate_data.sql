...
INSERT INTO `fitness`.`devices` (`version`, `serial_number`, `product`, `category`, `user_id`)
VALUES ('0', 'ABC123', 'Fitbit', 'Running', '1');

INSERT INTO `fitness`.`runs` (`version`,  `device_id`)
VALUES ('0', '1');

INSERT INTO `fitness`.`positions` (`version`, `longitude`,`latitude`,`altitude`, `run_id`)
VALUES ('0', '-87.6298', '41.8781','594','1');
